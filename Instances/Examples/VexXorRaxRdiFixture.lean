...
namespace Instances.Examples.VexXorRaxRdiFixture

open VexISA

def bytes : List UInt8 := [0x48, 0x31, 0xf8]

def block : Amd64Block :=
  mkAmd64Block [
      .wrTmp 2 (.get .rax),
      .wrTmp 1 (.get .rdi),
      .wrTmp 0 (.xor64 (.tmp 2) (.tmp 1)),
...
end Instances.Examples.VexXorRaxRdiFixture
