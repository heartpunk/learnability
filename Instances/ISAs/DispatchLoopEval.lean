...
def exprLoadsViaRegAddr : SymExpr Amd64Reg → Bool
  ...
  | .sub32 a b | .shl32 a b | .and32 a b | .or32 a b | .xor32 a b | .shl64 a b | .shr64 a b => exprLoadsViaRegAddr a || exprLoadsViaRegAddr b
  | _ => false
where
  ...
  | .add64 a b | .sub64 a b | .xor64 a b | .and64 a b | .or64 a b
  | .sub32 a b | .shl32 a b | .and32 a b | .or32 a b | .xor32 a b | .shl64 a b | .shr64 a b => addrUsesRegs a || addrUsesRegs b
