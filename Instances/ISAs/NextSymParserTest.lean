...
/-! ## Roundtrip test: all 59 next_sym blocks parse without error -/
...
private def nextSymBlocks : List String := [
  ...
  "IRSB {
   ...
   00 | ------ IMark(0x400077, 7, 0) ------
   01 | t5 = LDle:I64(0x0000000000500028)
   02 | PUT(rip) = 0x000000000040007e
   03 | ------ IMark(0x40007e, 2, 0) ------
   04 | t7 = LDle:I32(t5)
   05 | t19 = 32Uto64(t7)
   06 | t6 = t19
   07 | PUT(rax) = t6
   08 | ------ IMark(0x400080, 3, 0) ------
   09 | t20 = 64to32(t6)
   10 | t8 = t20
   11 | PUT(cc_op) = 0x0000000000000007
   12 | t21 = 32Uto64(t8)
   13 | t10 = t21
   14 | PUT(cc_dep1) = t10
   15 | PUT(cc_dep2) = 0x000000000000007d
   16 | PUT(rip) = 0x0000000000400083
   17 | ------ IMark(0x400083, 6, 0) ------
   18 | t24 = 64to32(t10)
   19 | t25 = 64to32(0x000000000000007d)
   20 | t23 = CmpEQ32(t24,t25)
   21 | t22 = 1Uto64(t23)
   22 | t17 = t22
   23 | t26 = 64to1(t17)
   24 | t12 = t26
   25 | if (t12) { PUT(rip) = 0x400127; Ijk_Boring }
   NEXT: PUT(rip) = 0x0000000000400089; Ijk_Boring
}",
  "IRSB {
   ...
   00 | ------ IMark(0x40034c, 7, 0) ------
   01 | t7 = LDle:I64(0x0000000000500030)
   02 | PUT(rip) = 0x0000000000400353
   03 | ------ IMark(0x400353, 2, 0) ------
   04 | t9 = LDle:I32(t7)
   05 | t26 = 32Uto64(t9)
   06 | t8 = t26
   07 | PUT(rip) = 0x0000000000400355
   08 | ------ IMark(0x400355, 7, 0) ------
   09 | t10 = LDle:I64(0x0000000000500048)
   10 | ------ IMark(0x40035c, 3, 0) ------
   11 | t27 = 64to32(t8)
   12 | t12 = t27
   13 | t28 = 32Sto64(t12)
   14 | t11 = t28
   15 | PUT(rdx) = t11
   16 | PUT(rip) = 0x000000000040035f
   17 | ------ IMark(0x40035f, 4, 0) ------
   18 | t16 = Shl64(t11,0x03)
   19 | t14 = Add64(t10,t16)
   20 | t18 = LDle:I64(t14)
   21 | PUT(rax) = t18
   22 | ------ IMark(0x400363, 3, 0) ------
   23 | PUT(cc_op) = 0x0000000000000014
   24 | PUT(cc_dep1) = t18
   25 | PUT(cc_dep2) = 0x0000000000000000
   26 | PUT(rip) = 0x0000000000400366
   27 | ------ IMark(0x400366, 2, 0) ------
   28 | t30 = CmpEQ64(t18,0x0000000000000000)
   29 | t29 = 1Uto64(t30)
   30 | t24 = t29
   31 | t31 = 64to1(t24)
   32 | t19 = t31
   33 | if (t19) { PUT(rip) = 0x400395; Ijk_Boring }
