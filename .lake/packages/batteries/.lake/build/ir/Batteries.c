...
lean_object* initialize_batteries_Batteries_Data_Bool(uint8_t builtin);
...
lean_object* initialize_batteries_Batteries_Data_RunningStats(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_batteries_Batteries_Data_Bool(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_batteries_Batteries_Data_RunningStats(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
